<!-- Modal -->
<div class="modal fade" id="idAddCity" tabindex="-1" role="dialog" aria-labelledby="idAddCityTitle" aria-hidden="true">
         ...
         <form action="{{route('cities.store')}}" method="post">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" id="idCity" placeholder="Ciudad">
                  {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
               </div>
               <div class="form-group">
