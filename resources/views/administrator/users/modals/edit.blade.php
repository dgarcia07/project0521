<!-- Modal -->
<div class="modal fade" id="idEditUser" tabindex="-1" role="dialog" aria-labelledby="idEditUserTitle" aria-hidden="true">
      ...
      <div class="modal-content">
         <form id="idFormEdit" action="#" method="post">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  <label for="idEditEmail">Correo</label>
                  <input type="email" name="email" class="form-control" id="idEditEmail" placeholder="Correo">
               </div>
               <div class="form-group">
